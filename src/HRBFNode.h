...
public:
	...
	static MObject exportComposition; // for exporting composition information to text
	int exportCompositionStatus; // for the program to check if it should export or not
...
MObject HRBFSkinCluster::exportComposition;
